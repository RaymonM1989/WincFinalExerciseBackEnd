...
router.post('/', auth, async (req, res) =>
{
    try
    {
        ...
        const requiredFields = [ "username", "password", "name", "email", "phoneNumber", "profilePicture", "aboutMe" ];
    ...
    {
        console.error(error);
        return res.status(500).send('Something went wrong while creating a new Host!');
    }
});
